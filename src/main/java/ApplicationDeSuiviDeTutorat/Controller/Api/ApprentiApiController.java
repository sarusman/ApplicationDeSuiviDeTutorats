...
public class ApprentiApiController {
    ...
    public List<ApprentiDto> getApprentisDuTuteur(Principal principal) {
    ...
    public ApprentiDto getApprenti(@PathVariable Long id) {
        return apprentiService.getApprentiDtoById(id)
                .orElseThrow(() ->
    ...
    public ApprentiDto createApprenti(@RequestBody ApprentiDto dto,
                                      Principal principal) {
        ...
        Apprenti saved = apprentiService.createApprenti(entity, tuteurId);

        return apprentiService.getApprentiDtoById(saved.getId())
                .orElseThrow(() ->
    ...
    public ApprentiDto updateApprenti(@PathVariable Long id,
                                      @RequestBody ApprentiDto dto,
                                      Principal principal) {
