-- SQL
INSERT IGNORE INTO entreprise (id, nom, raison_sociale, adresse, infos_acces) VALUES
...
INSERT IGNORE INTO apprenti (id, nom, prenom, adresse_electronique, telephone, programme, entreprise_id, tuteur_pedagogique_id) VALUES
...
INSERT IGNORE INTO visite (id, date, commentaire, apprenti_id) VALUES
  (301, '2025-03-15', 'Bilan intermédiaire', 201),
  (302, '2025-04-10', 'Suivi technique',     202),
  (303, '2025-05-20', 'Préparation soutenance', 203);
